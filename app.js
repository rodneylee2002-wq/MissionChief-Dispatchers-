...
<form class="form" id="requestForm">
  ...
  <div class="field">
    <label>Server *</label>
    <div class="choices" id="serverChoices">${["🇺🇸 US", "🇬🇧 UK", "🇦🇺 AU"]
      .map(
        (x) =>
          `<div class="choice" data-v="${x}" onclick="selectChoice(this,'serverChoices')">${x}</div>`
      )
      .join("")}</div>
  </div>
  <div class="field">
...
<form class="form" id="trainingForm">
  ...
  <div class="field">
    ...
    <div class="choices" id="tServerChoices">
      <div class="choice active" data-v="🇺🇸 US" onclick="selectServer(this)"><strong>US</strong></div>
      <div class="choice" data-v="🇬🇧 UK" onclick="selectServer(this)"><strong>UK</strong></div>
      <div class="choice" data-v="🇦🇺 AU" onclick="selectServer(this)"><strong>AU</strong></div>
    </div>
  </div>
  <div class="field">
